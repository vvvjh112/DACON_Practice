...
#cat
#파생변수
cat_train['Losses-Div'] = cat_train['Losses'] - cat_train['Dividends']
cat_test['Losses-Div'] = cat_test['Losses'] - cat_test['Dividends']

cat_train['work+Gain'] = cat_train['Working_Week (Yearly)'] + cat_train['Gains']
cat_test['work+Gain'] = cat_test['Working_Week (Yearly)'] + cat_test['Gains']
